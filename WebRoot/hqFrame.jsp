...
<frameset rows="*" id=frm1 cols="*" framespacing="0" frameborder="no" border="0">
  <frame src="${ctx}/hsdata_hq.action" name="hqList" frameborder="no" scrolling="auto" id="hqList" APPLICATION="yes">
</frameset>
<noframes>
<body>
