...
function winOpen(id)
{
   window.open("http://124.127.44.53:20023/vendue11/submit/broadcastDetail.jsp?id="+id,"bt","toolbar=no,location=no,scrollbars=yes,menubar=no,width=300,height=300,top=200,left=200");
}
function setValue(v)
{
   ct.innerHTML = v;
